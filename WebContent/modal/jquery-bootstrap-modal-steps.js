...
(function($){
    ...
    $.fn.modalSteps = function(bartitle,options){
        var $modal = this;
       // console.log($modal.find("[ data-title='"+bartitle+"']").length)
        ...
        var $progress_bar = $modal.find('#myBar');
        var width = Math.min(1 / ($modal.find("[ data-title='"+bartitle+"']").find('div[data-step]').length) * 100, 100);
        //
        ...
        $modal.find('.js-btn-step').on('click', function(){
            ...
            steps = $modal.find("[ data-title='"+bartitle+"']").length;
            ...
            if (orientation === 'next'){
                ...
                $progress_bar.animate({
                    width: Math.min((actualStep+1) / (steps) * 100, 100) + '%'
                });
                ...
                $progress_bar.animate({
                    width: Math.min(nextStep / (steps) * 100, 100) + '%'
                });
